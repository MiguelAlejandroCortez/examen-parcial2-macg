...
public class SmartHome {
    ...
    public void configure(String deviceName, String voiceCommand, String standarCommand) {
        Device device = findDeviceByName(deviceName);

        if(device!= null){
            DeviceWithCommand deviceWithCommand = new DeviceWithCommand(device, voiceCommand, standarCommand);
